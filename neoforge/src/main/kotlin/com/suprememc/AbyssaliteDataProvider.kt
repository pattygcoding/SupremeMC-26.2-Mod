...
class AbyssaliteDataProvider(output: PackOutput) : EcosystemDataProvider(output) {
    ...
    override fun run(cache: CachedOutput): CompletableFuture<*> {
        ...
        writes += save(cache, obj { addProperty("type", "neoforge:add_features"); add("biomes", array("#minecraft:is_ocean")); addProperty("features", "$namespace:atlantis_debris"); addProperty("step", "underground_ores") }, dataPath("neoforge/biome_modifier/add_atlantis_debris.json"))
