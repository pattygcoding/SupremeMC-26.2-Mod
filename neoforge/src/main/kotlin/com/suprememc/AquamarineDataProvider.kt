...
class AquamarineDataProvider(output: PackOutput) : EcosystemDataProvider(output) {
    ...
    override fun run(cache: CachedOutput): CompletableFuture<*> {
        ...
        writes += save(cache, valuesTag("$namespace:aquamarine_ore", "$namespace:deepslate_aquamarine_ore", "$namespace:aquamarine_block"), minecraftDataPath("tags/block/mineable/pickaxe.json"))
